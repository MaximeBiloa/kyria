                            ...
                            onTap: () {
                              for (int i = 0;
                                ...
                                dynamic firebaseDiscussionFormat = {
                                  ...
                                  'formated_hour':
                                      DateTime.now().microsecondsSinceEpoch,
                                  'online_state': DiscussionModel.fromJson(
                                          listeDiscussions[i])
                                      .online_state,
                                ...
                                discussionProvider
                                    .saveDiscussion(firebaseDiscussionFormat);
                              }
                            },
                            child: Image.asset(
                            ...
                            children: [
                              ...
                              Expanded(
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                      color: themeMode
                                          ? Color(0xFF3C474D).withOpacity(0.08)
                                          : Colors.white),
                                  child: Scrollbar(
                                    thickness: 2,
                                    child: ListView.builder(
                                        physics: BouncingScrollPhysics(),
                                        itemCount: listeDiscussions.length,
                                        itemBuilder:
                                            (BuildContext context, int index) {
                                          var discussion =
                                              DiscussionModel.fromJson(
                                                  listeDiscussions[index]);
            ...
            Positioned(
              ...
              child: ClipOval(
                child: Material(
                  ...
                  child: InkWell(
                    splashColor: greenColor.withOpacity(0.2), // Splash color
                    onTap: () {
                      Navigator.push(
                          context,
                          PageRouteBuilder(
